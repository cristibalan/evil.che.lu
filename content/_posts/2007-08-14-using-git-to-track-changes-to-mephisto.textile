--- 
title: Using git to track changes to mephisto
extension: html
directory: 2007/08/14
tags: 
- git
- mephisto
- scm
...
- home
blog_post: true
filename: using-git-to-track-changes-to-mephisto
layout: post
created_at: 2007-08-14 15:04:00 +02:00
---
h3. Prerequisites

h4. "svn":http://subversion.tigris.org/ and perl bindings
...
h3. 1. Create local git repositories
...
h3. 2b. Existing mephisto customization
...
h4. Getting changes from mephisto
...
h4. Pushing new changes in svn (and pulling changes from svn)
